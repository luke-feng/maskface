...
def model():
    ...
    generator_optimizer = keras.optimizers.RMSprop(lr=0.0008, clipvalue=1.0, decay=1e-8)
...
training_input_path = os.path.join(path,'input/')
img_path = glob.glob(training_input_path +"*.jpeg")
path_save = training_input_path
